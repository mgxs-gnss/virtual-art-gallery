...
const mapSize = 7; // Log2 of the grid size (keep the value between [1, 6])
const cellSize = 12; // Size of the rooms
const mapHeight = 6.5; // Height of the walls
const wallThickness = 1.5; // Wall thickness
const wallRemoval = 0.6; // Random wall removal proportion
